...
const Links = () => {
  ...
  const newProductUrl1 = bioData[0].newProductUrl1; // get product url if available
            ...
            <LinkSection>
              ...
              {(newProduct) ? <NewSection>
                <a href={newProductUrl} target="_blank" rel="noreferrer">
                  <img
                    src={'/Range_Shop Online Email_Hero_8_3.png'}
              ...
              {(newProduct) ? <NewSection>
                <a href={newProductUrl1} target="_blank" rel="noreferrer">
                  <img
                    src={'/Range-Banner_Winchester-Sporting-Clays_1800x600-1.png'}
                    className="newproduct"
                  />
                </a>
              </NewSection> : ''
